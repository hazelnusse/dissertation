...
%    \addplot table[x=time,y=v]{data/000-time-steer-steer_est-v-v_c-20.00-35.00-decimated.txt};
%    \addlegendentry{Measured}
%    \addplot table[x=time,y=v_c]{data/000-time-steer-steer_est-v-v_c-20.00-35.00-decimated.txt};
%    \addlegendentry{Commanded}
%    \end{axis}
%  \end{tikzpicture}
%  \caption{Forward speed response for run 000.}
%  \label{rb:fig:velocity_tracking000}
%\end{figure}
%\begin{figure}[htbp]
%  \centering
%  \begin{tikzpicture}
...
%    \addplot table[x=time,y=steer]{data/000-time-steer-steer_est-v-v_c-20.00-35.00-decimated.txt};
%    \addlegendentry{Measured}
%    \addplot table[x=time,y=steer_est]{data/000-time-steer-steer_est-v-v_c-20.00-35.00-decimated.txt};
%    \addlegendentry{Estimated}
%    \end{axis}
%  \end{tikzpicture}
%  \caption{Steer angle measurement and estimate for run 000.}
%  \label{rb:fig:steer_response000}
%\end{figure}
...
\begin{figure}
  ...
  \caption[Run 000 speed and steer response.]{Run 000, measured speed
    ...
    $\delta$, and estimated steer angle \ref{estimated_steer}
    $\hat{\delta}$. The momentary switch state \ref{hw_button} indicates
    the bicycle was released at $t$=21.56s, shortly before state estimation began
    at $t$=21.62s (\ref{measured_v} $v$ = 1 m / s). See
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}
  \caption[Run 000 steer rate measured and estimated.]{The measured steer rate
    was the result of applying a low pass filtered ideal derivative $G(s) =
    20\pi s/(s+20\pi)$ to the steer angle measurement. The noise in this signal
    is directly proportional to steer angle quantization error and inversely
    proportional to sample period.}
...
%      x=time,
%      y=gyro_x
%    ]{data/000-time-gyro_x-lean_rate_est-20.00-30.00-decimated.txt};
%    \label{measured_lean_rate}
%    \addplot[black] table[
%      x=time,
%      y=lean_rate_est
%    ]{data/000-time-gyro_x-lean_rate_est-20.00-30.00-decimated.txt};
%    \label{estimated_lean_rate}
%    \end{axis}
%    \begin{axis}[
%      y axis style/.style={
%        yticklabel style=#1,
...
%      x=time,
%      y=steer_rate
%    ]{data/000-time-steer_rate-steer_rate_est-20.00-30.00-decimated.txt};
%    \label{measured_steer_rate}
%    %\addlegendentry{Measured}
%    \addplot[brown] table[
%      x=time,
%      y=steer_rate_est
%    ]{data/000-time-steer_rate-steer_rate_est-20.00-30.00-decimated.txt};
%    \label{estimated_steer_rate}
%    %\addlegendentry{Estimated}
%    \end{axis}
%  \end{tikzpicture}
%  \caption[Steer rate measurement and estimate for run 000.]{}
%  \label{rb:fig:run000b}
%\end{figure}
